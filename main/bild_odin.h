...
public:
	...
	void init()
	{
		...
		this->xsize.setElsize(geo.get_FOV(readDirection)/this->xsize.getCnt('X'));
    this->ysize.setElsize(geo.get_FOV(phaseDirection)/this->ysize.getCnt('Y'));
    this->zsize.setElsize(geo.get_FOV(sliceDirection)/this->zsize.getCnt('Z'));
	}
	~Bild_odin(){
	}
